...
class HREmployeeSearch extends SearchDelegate {
  @override
  HREmployeeSearch()
      : super(
      ...
      builder: (context, snapshot) {
        ...
        return ListView(
          children: snapshot.data!.docs.map((DocumentSnapshot doc) {
            ...
            return HRItems.employeeItem(
              context: context,
              data: data,
              onPressedEdit: () =>
                  navigateTo(context, HRUpdateEmployeeScreen(data: data)),
              onPressedSalary: () =>
                  navigateTo(context, HRAddSalaryScreen(data: data)),
              onPressedYes: () {
