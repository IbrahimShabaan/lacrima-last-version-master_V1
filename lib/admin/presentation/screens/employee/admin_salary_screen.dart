...
class AddSalaryScreen extends StatelessWidget {
  AddSalaryScreen({Key? key, required this.data}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    totalVacationController.text = data['totalVacations'].toString();
    DateTime now = DateTime.now();
    return BlocConsumer<EmployeeCubit, EmployeeStates>(
      listener: (context, state) {
        if (state is UpdateSalaryEmployeeSuccessState) {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  BuildCondition(
                    condition: state is! UpdateSalaryEmployeeLoadingState,
